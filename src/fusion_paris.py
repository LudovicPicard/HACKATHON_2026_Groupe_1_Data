...
# Code de la station Paris-Montsouris
station_paris = 75114001  
output_file = os.path.join(path, "dataset_paris_complet.csv")

# Liste des fichiers RR-T-Vent pour Paris (75)
files_to_merge = [
    "Q_75_1816-1949_RR-T-Vent.csv.gz",
...
print("🚀 Début de l'unification des données pour Paris (Toutes colonnes)...")
...
for file in files_to_merge:
    ...
    if os.path.exists(file_path):
        ...
        # 2. Filtrage immédiat sur la station de Paris-Montsouris
        df_filtered = df[df['NUM_POSTE'] == station_paris].copy()
...
if all_data:
    ...
    print("-" * 30)
    print(f"✅ Terminé avec succès pour Paris !")
    ...
    print("❌ Aucune donnée n'a pu être chargée pour Paris.")