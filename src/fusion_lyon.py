...
# Code de la station Lyon-Bron (Référence historique)
station_lyon = 69029001  
output_file = os.path.join(path, "dataset_lyon_complet.csv")

# Liste des fichiers RR-T-Vent pour le Rhône (69)
files_to_merge = [
    "Q_69_1851-1949_RR-T-Vent.csv.gz",
    "Q_69_previous-1950-2024_RR-T-Vent.csv.gz",
    "Q_69_latest-2025-2026_RR-T-Vent.csv.gz"
]

all_data = []

print("🚀 Début de l'unification des données pour Lyon (Toutes colonnes)...")
...
for file in files_to_merge:
    ...
    if os.path.exists(file_path):
        ...
        # 2. Filtrage immédiat sur la station de Lyon-Bron
        df_filtered = df[df['NUM_POSTE'] == station_lyon].copy()
...
if all_data:
    ...
    print("-" * 30)
    print(f"✅ Terminé avec succès pour Lyon !")
    ...
    print("❌ Aucune donnée n'a pu être chargée pour Lyon.")