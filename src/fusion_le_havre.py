...
# Code de la station Le Havre - Octeville (Référence historique)
station_le_havre = 76481001  
output_file = os.path.join(path, "dataset_le_havre_complet.csv")

# Liste des fichiers RR-T-Vent pour la Seine-Maritime (76)
files_to_merge = [
    "Q_76_1845-1949_autres-parametres.csv.gz",
    "Q_76_previous-1950-2024_RR-T-Vent.csv.gz",
    "Q_76_latest-2025-2026_RR-T-Vent.csv.gz"
]

all_data = []

print("🚀 Début de l'unification des données pour Le Havre (Toutes colonnes)...")
...
for file in files_to_merge:
    ...
    if os.path.exists(file_path):
        ...
        # 2. Filtrage immédiat sur la station du Havre
        df_filtered = df[df['NUM_POSTE'] == station_le_havre].copy()
...
if all_data:
    ...
    print("-" * 30)
    print(f"✅ Terminé avec succès pour Le Havre !")
    ...
    print("❌ Aucune donnée n'a pu être chargée pour Le Havre.")