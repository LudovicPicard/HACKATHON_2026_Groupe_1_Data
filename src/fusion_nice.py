...
# Code de la station Nice-Côte d'Azur (Référence historique)
station_nice = 6088001  
output_file = os.path.join(path, "dataset_nice_complet.csv")

# Liste des fichiers RR-T-Vent pour les Alpes-Maritimes (06)
files_to_merge = [
    "Q_06_1877-1949_RR-T-Vent.csv.gz",
    "Q_06_previous-1950-2024_RR-T-Vent.csv.gz",
    "Q_06_latest-2025-2026_RR-T-Vent.csv.gz"
]

all_data = []

print("🚀 Début de l'unification des données pour Nice (Toutes colonnes)...")
...
for file in files_to_merge:
    ...
    if os.path.exists(file_path):
        ...
        # 2. Filtrage immédiat sur la station de Nice
        df_filtered = df[df['NUM_POSTE'] == station_nice].copy()
...
if all_data:
    ...
    print("-" * 30)
    print(f"✅ Terminé avec succès pour Nice !")
    ...
    print("❌ Aucune donnée n'a pu être chargée pour Nice.")