...
# Code de la station Dijon-Longvic (Référence historique)
station_dijon = 21231001  
output_file = os.path.join(path, "dataset_dijon_complet.csv")

# Liste des fichiers RR-T-Vent pour la Côte-d'Or (21)
files_to_merge = [
    "Q_21_1845-1949_RR-T-Vent.csv.gz", 
    "Q_21_previous-1950-2024_RR-T-Vent.csv.gz",
    "Q_21_latest-2025-2026_RR-T-Vent.csv.gz"
]

all_data = []

print("🚀 Début de l'unification des données pour Dijon (Toutes colonnes)...")
...
for file in files_to_merge:
    ...
    if os.path.exists(file_path):
        ...
        # 2. Filtrage immédiat sur la station de Dijon
        df_filtered = df[df['NUM_POSTE'] == station_dijon].copy()
...
if all_data:
    ...
    print("-" * 30)
    print(f"✅ Terminé avec succès pour Dijon !")
    ...
    print("❌ Aucune donnée n'a pu être chargée pour Dijon.")