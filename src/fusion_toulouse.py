...
# Code de la station Toulouse-Blagnac (Aéroport)
station_toulouse = 31069001  
output_file = os.path.join(path, "dataset_toulouse_complet.csv")

# Liste des fichiers RR-T-Vent pour la Haute-Garonne (31)
files_to_merge = [
    "Q_31_1809-1949_RR-T-Vent.csv.gz",
...
print("🚀 Début de l'unification des données pour Toulouse (Toutes colonnes)...")
...
for file in files_to_merge:
    ...
    if os.path.exists(file_path):
        ...
        # 2. Filtrage immédiat sur la station de Toulouse-Blagnac
        df_filtered = df[df['NUM_POSTE'] == station_toulouse].copy()
...
if all_data:
    ...
    print("-" * 30)
    print(f"✅ Terminé avec succès pour Toulouse !")
    ...
    print("❌ Aucune donnée n'a pu être chargée pour Toulouse.")