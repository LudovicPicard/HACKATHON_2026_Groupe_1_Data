...
# Code de la station Lille-Lesquin (Référence historique)
station_lille = 59343001  
output_file = os.path.join(path, "dataset_lille_complet.csv")

# Liste des fichiers RR-T-Vent pour le Nord (59)
files_to_merge = [
    "Q_59_1848-1949_RR-T-Vent.csv.gz",
...
print("🚀 Début de l'unification des données pour Lille (Toutes colonnes)...")
...
for file in files_to_merge:
    ...
    if os.path.exists(file_path):
        ...
        # 2. Filtrage immédiat sur la station de Lille
        df_filtered = df[df['NUM_POSTE'] == station_lille].copy()
...
if all_data:
    ...
    print("-" * 30)
    print(f"✅ Terminé avec succès pour Lille !")
    ...
    print("❌ Aucune donnée n'a pu être chargée pour Lille.")