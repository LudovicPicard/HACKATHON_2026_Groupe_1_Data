...
# Code de la station Saint-Étienne - Bouthéon (Référence historique)
station_st_etienne = 42005001  
output_file = os.path.join(path, "dataset_st_etienne_complet.csv")

# Liste des fichiers RR-T-Vent pour la Loire (42)
files_to_merge = [
    "Q_42_1877-1949_RR-T-Vent.csv.gz",
    "Q_42_previous-1950-2024_RR-T-Vent.csv.gz",
    "Q_42_latest-2025-2026_RR-T-Vent.csv.gz"
]

all_data = []

print("🚀 Début de l'unification des données pour Saint-Étienne (Toutes colonnes)...")
...
for file in files_to_merge:
    ...
    if os.path.exists(file_path):
        ...
        # 2. Filtrage immédiat sur la station de Saint-Étienne
        df_filtered = df[df['NUM_POSTE'] == station_st_etienne].copy()
...
if all_data:
    ...
    print("-" * 30)
    print(f"✅ Terminé avec succès pour Saint-Étienne !")
    ...
    print("❌ Aucune donnée n'a pu être chargée pour Saint-Étienne.")